  ...
  const handleApplyJob = async () => {
    ...
    try {
      ...
      if (res?.success) {
        ...
        // Update job details to reflect new application count
        getJobDetails();
      } else {
      ...
      <div className='w-full flex flex-col md:flex-row gap-10'>
        ...
        <div className='w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md'>  
            ...
            <div 
              ...
              onClick={() => {
                if (user?._id === job?.company?._id) {
                  ...
                  alert("Only recruiters can view applicants");
                } else {
                  alert("You can only view applicants for your own job posts");
                }
              }}
            >
          ...
          <div className='w-full'>
            ...
            <CustomButton
              title={hasApplied ? '✅ Already Applied' : isApplying ? '⏳ Applying...' : '🚀 Apply Now'}
